...
const Contact = () => {
  ...
  <div id="contact-map" className="contact-map">
    <h1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab accusamus, obcaecati sint sit enim et inventore laboriosam labore dolorem repellat quidem voluptate excepturi maiores vitae quibusdam. Eveniet voluptatum id quos? raju</h1>
    <NavLink to ="/map">click</NavLink>
