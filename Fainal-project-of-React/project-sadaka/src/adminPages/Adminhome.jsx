      ...
      <div id="page-inner">
          ...
          <div className="col-md-8">
                    ...
                    <div className="item active">
                      <div className="col-md-10 col-md-offset-1">
                        <h4>
                          ...
                          Lorem ipsum dolor sit amet, consectetur adipiscing
                          elit onec molestie non sem vel condimentum.{" "}
                          <i className="fa fa-quote-right" />
                        </h4>
                        <div className="user-img pull-right">
                          <img
                            src="adminAssets/assets/img/user.gif"
                            alt=""
                            className="img-u image-responsive"
                          />
                        </div>
                        <h5 className="pull-right">
                          <strong className="c-black">Lorem Dolor</strong>
                        </h5>
                      </div>
                    </div>
                    <div className="item">
                      <div className="col-md-10 col-md-offset-1">
                        ...
                        <div className="user-img pull-right">
                          <img
                            src="adminAssets/assets/img/user.png"
                            alt=""
                            className="img-u image-responsive"
                          />
                        </div>
            ...
            <div className="panel panel-default">
              ...
              >
                <div className="carousel-inner">
                  <div className="item active">
                    <img src="adminAssets/assets/img/slideshow/1.jpg" alt="" />
                  </div>
                  <div className="item">
                    <img src="adminAssets/assets/img/slideshow/2.jpg" alt="" />
                  </div>
                  <div className="item">
                    <img src="adminAssets/assets/img/slideshow/3.jpg" alt="" />
                  </div>
                </div>
                {/*INDICATORS*/}
                <ol className="carousel-indicators">
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <div className="panel panel-success">
              <div className="panel-heading">Recent Comments Example</div>
              <div className="panel-body">
                    ...
                    <div className="media-body">
                      <div className="media">
                        <a className="pull-left" href="#">
                          <img
                            className="media-object img-circle img-comments"
                            src="adminAssets/assets/img/user.png"
                          />
                        </a>
                        <div className="media-body">
        ...
        <div className="row" style={{ paddingBottom: 100 }}>
          <div className="col-md-6">
            <div id="comments-sec">
              <h4>
                <strong>Compose Support Ticket </strong>
              </h4>
              <hr />
              <div className="form-group  ">
                ...
                <input
                  ...
                  className="form-control"
                  required="required"
                  placeholder="Enter Subject Of Ticket"
                />
              </div>
              <div className="form-group ">
          ...
          <div className="col-md-6">
            <div className="panel panel-back noti-box">
              ...
              <div className="text-box">
                ...
                <hr />
                <p>
                  <span className=" color-bottom-txt">
                    <i className="fa fa-edit" />
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit
                    gthn. Lorem ipsum dolor sit amet, consectetur adipiscing
                    elit gthn. Lorem ipsum dolor sit amet, consectetur
                    adipiscing elit gthn.
                  </span>
                </p>
                <hr />
